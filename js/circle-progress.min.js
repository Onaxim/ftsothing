      ...
      ((t = function (t, e, r, n) {
        ...
        if (
          ...
          return (
            ...
            e && r && i.setAttribute("viewBox", "0 0 " + e + " " + r),
            t.appendChild(i),
            (a.svg = i),
            a
          );
    ...
    ((e = (function () {
      function s(t) {
        ...
        ((t.circleProgress = this).doc = n),
          ...
          (this.graph = { paper: i(t, 100, 100), value: 0 }),
          ...
          [
              ...
              value: function (t, e) {
                ...
                this._attrs[t] !== e &&
                  (("min" === t && e >= this.max) ||
                    ...
                    "textFormat" === t &&
                      (this._initText(),
                      (r = "valueOnCircle" === e ? 16 : 8),
                      this.graph.sector.attr("stroke-width", r),
                      this.graph.circle.attr("stroke-width", r))));
              },
            },
            {
              key: "_formatValue",
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                this.graph.textVal.attr({ x: 50 + r.x, y: 50 + r.y });
              },
            },
            {
              key: "_initText",
                  ...
                  case "valueOnCircle":
                    (this.graph.textVal = this.graph.paper.element(
                      "tspan",
                      {
                        ...
                        "font-size": "12",
                        fill:
                          "valueOnCircle" === this.textFormat ? "#fff" : "#888",
                      },
                      "",
                      this.graph.text
                    )),
            ...
            },
            {
              ...
              value: function () {
                ...
                this._isIndeterminate()
                  ? this._updateText(this.value, i, a)
                  : ((e = this.clockwise),
                    (r = this._valueToAngle()),
                    ...
                    "none" !== this.animation && this.value !== this.graph.value
                      ? h(
                          ...
                          function (t) {
                            n._updateText(Math.round(t), (2 * i + r) / 2, a),
                              ...
                              n.graph.sector.attr(
                                "d",
                                s._makeSectorPath(50, 50, a, i, r, e)
                              );
                          }
                        )
                      : (this.graph.sector.attr(
                        ...
                        this._updateText(this.value, (2 * i + r) / 2, a)),
              ...
              value: function (t, e, r) {
                "function" == typeof this.textFormat
                  ...
                  ? (this.graph.text.el.textContent =
                      void 0 !== t ? t : this.indeterminateText)
                  : "percent" === this.textFormat
                  ? (this.graph.text.el.textContent =
                      (void 0 !== t && null != this.max
                  ...
                  : ((this.graph.textVal.el.textContent =
                    ...
                    (this.graph.textMax.el.textContent =
                      void 0 !== this.max ? this.max : this.indeterminateText)),
                  "valueOnCircle" === this.textFormat &&
                    this._positionValueText(e, r);
              },
            },
            {
              key: "_getRadius",
          ...
          [
            {
              ...
              value: function (t, e, r, n, i, a) {
                0 < i && i < 0.3 ? (i = 0) : 359.999 < i && (i = 359.999);
                var s = n + i * (2 * (a = !!a) - 1),
